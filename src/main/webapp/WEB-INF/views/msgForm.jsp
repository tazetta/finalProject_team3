...
<html>
	...
	<form name="msgForm" method="GET">
        <tr>
            <th>보내는 사람</th>
            <td><input id="sender" type="text" name="sender" value="${loginId}"></td>
        </tr>
        <tr>
            <th>받는 사람</th>
        ...
        <tr>
            <th>내용</th>
            <td><textarea id="content" name="content" id="" cols="30" rows="10"></textarea></td>
        </tr>
        <tr>
		       <th>
		      	 	<input type="button" onclick="goSubmit()"/>
		       </th>
        </tr>
   </table>
	</form>
