...
<body>
	<div class="flexBox">
		...
		<div>
			...
			<div id="totaldiv" class="container" 
				style="font-size: large; display:block; font-weight: bold; padding-left: 40px;">
				<div id="list"
					style="display: flex; flex-flow: wrap; justify-content: center; border: 1px solid rgb(255, 255, 255);">
...
<script>
	...
	function listPrint(list) {
		...
		for (var i = 0; i < list.length; i++) {
			...
			content += "<tr>"
			content += "<th style='border-color: white;'><a href='examDetail?combrdIdx="
					+ list[i].combrdIdx + "'>" + list[i].subject + "</a></th>"
			content += "</tr>"
			content += "<tr>"
			content += "<td><a href='interiorCompanyDetail?comId="
					+ list[i].comId + "'>" + list[i].comId + "</a></td>"
			content += "</tr>"
			content += "</table>"
			content += "</div>"
