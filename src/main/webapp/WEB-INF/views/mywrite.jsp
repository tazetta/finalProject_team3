				...
				<tr>
                   	<th style="width:70px">글 번호</th>
						...
						<th style="width:100px">작성일</th>
      					...
      					<tbody id="list2" style="font-size: 18px; text-align: center;">
             			</tbody>
					<tr>
			<td id="paging" colspan="6">
				<!-- 플러그인 사용 -->
                   ...
                   <table>
                   	...
                   	<th style="width:70px">글 번호</th>
						...
						<th style="width:100px">작성일</th>
      				 	...
      				 	<tbody id="list3" style="font-size: 18px; text-align: center;">
             			</tbody>
						<tr>
			<td id="paging" colspan="6">
				<!-- 플러그인 사용 -->
					 ...
					 <tr>
                   	<th style="width:70px">글 번호</th>
						...
						<th style="width:100px">작성일</th>
      				 	...
      				 	<tbody id="list4" style="font-size: 18px; text-align: center;">
